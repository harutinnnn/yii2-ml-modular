...
<div class="post-form">
    ...
    <div class="card card-primary">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <?= $form->field($model, 'status')->dropDownList(\common\models\EducationPlan::statusOptions()) ?>
                </div>
                <div class="col-md-6">
    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-footer">
            <?= Html::submitButton($model->education_plan === null ? 'Create' : 'Update', ['class' => 'btn btn-primary']) ?>
