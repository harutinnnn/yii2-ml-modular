...
/** @var common\models\EducationalPrograms $model */

use common\helpers\EditorJsHelper;
use yii\helpers\Html;

$this->title = 'View Educational Program #' . $model->id;
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php foreach ($model->translations as $translation): ?>
                ...
                <h5><?= Html::encode(strtoupper($translation->lang)) ?>: <?= $levels[$model->education_level] ?></h5>
            <?php endforeach; ?>
        </div>
    </div>
</div>
