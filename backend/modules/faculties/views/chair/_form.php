...
<div class="chair-content-form">
    ...
    <div class="card card-primary">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <?= $form->field($model, 'status')->dropDownList(Chairs::statusOptions()) ?>
                </div>
                ...
                <div class="col-md-6">
                    <?= $form->field($model, 'faculty_id')->dropDownList($faculties ?? []) ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-footer">
            <?= Html::submitButton($model->chairs === null ? 'Create' : 'Update', ['class' => 'btn btn-primary']) ?>
