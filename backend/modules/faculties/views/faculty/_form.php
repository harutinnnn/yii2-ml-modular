...
<div class="faculty-content-form">
    ...
    <div class="card card-primary">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <?= $form->field($model, 'status')->dropDownList(Faculties::statusOptions()) ?>
                </div>
    ...
    <div class="card card-outline card-primary">
                ...
                <?php foreach ($languages as $index => $language): ?>
                    <li class="nav-item">
                        <a
                                ...
                                id="faculty-lang-tab-<?= Html::encode($language->code) ?>"
                                data-toggle="pill"
                                href="#faculty-lang-pane-<?= Html::encode($language->code) ?>"
                                role="tab"
                                aria-controls="faculty-lang-pane-<?= Html::encode($language->code) ?>"
            ...
            <div class="tab-content">
                <?php foreach ($languages as $index => $language): ?>
                    <div
                            ...
                            id="faculty-lang-pane-<?= Html::encode($language->code) ?>"
                            role="tabpanel"
                            aria-labelledby="faculty-lang-tab-<?= Html::encode($language->code) ?>"
                    >
        ...
        <div class="card-footer">
            <?= Html::submitButton($model->faculties === null ? 'Create' : 'Update', ['class' => 'btn btn-primary']) ?>
