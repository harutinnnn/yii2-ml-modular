...
/** @var backend\modules\faculties\models\FacultiesSearch $searchModel */
...
<div class="faculty-content-index">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <?= Html::a('Create Faculty', ['create'], ['class' => 'btn btn-primary']) ?>
    </div>
        ...
        <div class="card-body p-0">
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'status',
                        'filter' => \common\models\Faculties::statusOptions(),
