...
/** @var backend\modules\statuses\models\StatusesSearch $searchModel */
...
<div class="statuses-index">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <?= Html::a('Create Status', ['create'], ['class' => 'btn btn-primary']) ?>
    </div>
        ...
        <div class="card-body p-0">
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'status',
                        'filter' => \common\models\Statuses::statusOptions(),
