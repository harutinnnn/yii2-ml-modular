 ...
 *
 * @property AnnouncementsMl[] $translations
 */
class Announcements extends ActiveRecord
{
    ...
    {
        return $this->hasMany(AnnouncementsMl::class, ['announcements_id' => 'id'])->indexBy('lang');
    }

    public function getTranslation(string $lang): ?AnnouncementsMl
    {
