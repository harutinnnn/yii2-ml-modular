 ...
 *
 * @property EducationLevelsMl[] $translations
 */
class EducationLevels extends ActiveRecord
{
    ...
    {
        return $this->hasMany(EducationLevelsMl::class, ['education_level_id' => 'id'])->indexBy('lang');
    }

    public function getTranslation(string $lang): ?EducationLevelsMl
    {
