 ...
 *
 * @property EventsMl[] $translations
 */
class Events extends ActiveRecord
{
    ...
    public function rules(): array
    {
        return [
            ...
            [['status'], 'integer'],
            [['image','date','time'], 'string', 'max' => 255],
    ...
    {
        return $this->hasMany(EventsMl::class, ['events_id' => 'id'])->indexBy('lang');
    }

    public function getTranslation(string $lang): ?EventsMl
    {
